...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('services.index') }}" style="margin-bottom:5px">Back</a>
    <form role="form" method="POST" action="{{ route('services.store') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
                ...
                <div>
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">ICON</a></li>
                  </ul>
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane " id="settings">
                        <div class="form-group" style="margin-top:10px;margin-bottom:10px">                            
                          <div class="col-md-9">
                            <img id="thumbnail_image" src="{{ old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('public/admin/dist/img/img.png') }}" class="img-thumbnail" width="40" height="40">
            ...
            <div class="box-footer">             
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('services.index')}}">Cancel</a>
            </div>
