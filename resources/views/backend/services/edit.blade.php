...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('services.update') }}" id="dataForm">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane " id="settings">
                        <div class="form-group" style="margin-top:10px;margin-bottom:10px">                            
                          <div class="col-md-9">
                            <img id="thumbnail_image" src="{{ old('image_url', $detail->image_url) ? Helper::showImage(old('image_url', $detail->image_url)) : URL::asset('public/admin/dist/img/img.png') }}" class="img-thumbnail" width="40" height="40">
            ...
            <div class="box-footer">             
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('services.index')}}">Hủy</a>
            </div>
