...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('content.index') }}" style="margin-bottom:5px">
                  ...
                  <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">                        
                        <div class="form-group" >                  
                          ...
                          <textarea id="content_1" rows="10" class="form-control" name="content[1]">{!! $detailArr[1]->content !!}</textarea>
                        </div>                        
                    </div><!--end thong tin co ban--> 
                    <div role="tabpanel" class="tab-pane" id="homeEn">                        
                        <div class="form-group" >                  
                          <label>Content <span class="red-star">*</span></label>
                          <textarea id="content_2" rows="10" class="form-control" name="content[2]">{!! $detailArr[2]->content !!}</textarea>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="homeVn">                        
                        <div class="form-group" >                  
                          <label>Content <span class="red-star">*</span></label>
                         <textarea id="content_3" rows="10" class="form-control" name="content[3]">{!! $detailArr[3]->content !!}</textarea>
                        </div>
